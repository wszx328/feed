...
const ITEMS = [
  ...
  },
  {
    id: 'divination_dice',
    name: '占卜骰子',
    effect: '立即刷新当前选项，并指定其中一种食物出现',
    price: 10,
    icon: '🎲',
    description: '一颗没有点数的苍白骰子。抛下它，当前的食物选项会被重新洗牌，并确保你选中的食物出现在下一批菜单里。掌控权短暂地回到了你的手里。',
    type: 'active',
    consumable: true
  },
  {
  ...
  },
  {
    id: 'syringe',
    name: '废弃针管',
    effect: '立即扣除10秒，随机强制投喂5份食物',
    price: 15,
    icon: '💉',
    description: '一根带有干涸血迹的医疗废弃物，针头处闪烁着危险的寒芒。\n“把针头扎进自己的静脉，用生命力去填补祂的胃口。疼痛是最好的开胃菜。”',
    type: 'active',
    consumable: true
  },
  {
    id: 'ash_jar',
    name: '香灰坛',
    effect: '本局“烤串”全部替换为“香灰（麻木）”',
    price: 12,
    icon: '⚱️',
    description: '从酒店民俗陈列室里顺出来的冷硬瓷罐，里面装着满满的死寂。\n“在深渊面前，快乐是极度危险的奢侈品，只有绝对的麻木才能换来片刻安宁。”',
    type: 'passive',
    consumable: false,
    consumedAtEnd: true
  },
  {
    id: 'monocle',
    name: '肮脏的单片镜',
    effect: '10秒内暂停暴走计时，但食物名变乱码',
    price: 10,
    icon: '🧐',
    description: '镜片上沾染着某种不可名状的黏液。戴上它，就能强行屏蔽高维度的精神污染，代价是暂时失去对现实的认知。\n“闭上眼睛随便喂吧，反正你看见的也不一定是真的。”',
    type: 'active',
    consumable: false,
    consumedAtEnd: true,
    reusable: true
